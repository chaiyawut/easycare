...
urlpatterns = patterns('',
        ...
        url(r'^records/weight_graph/(?P<patient_id>\d+)/$', 'frontend.views.graph_weight', name="record-graph-weight"),
        url(r'^records/drug_graph/(?P<patient_id>\d+)/$', 'frontend.views.graph_drug', name="record-graph-drug"),
        url(r'^records/pressure_graph/(?P<patient_id>\d+)/$', 'frontend.views.graph_pressure', name="record-graph-amount"),
