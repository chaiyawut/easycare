...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('frontend_patient', (
            ...
            ('confirm_by', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        ...
        db.create_table('frontend_record', (
            ...
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 12, 13, 0, 0))),
    ...
    models = {
        ...
        'frontend.record': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
