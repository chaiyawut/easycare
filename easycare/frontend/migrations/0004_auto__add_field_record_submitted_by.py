...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.submitted_by'
        db.add_column('frontend_record', 'submitted_by',
                      self.gf('django.db.models.fields.CharField')(default='sms', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.submitted_by'
        db.delete_column('frontend_record', 'submitted_by')
