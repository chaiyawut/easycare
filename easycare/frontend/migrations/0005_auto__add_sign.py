...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sign'
        db.create_table('frontend_sign', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('record', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['frontend.Record'])),
            ('sign', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('frontend', ['Sign'])


    def backwards(self, orm):
        # Deleting model 'Sign'
        db.delete_table('frontend_sign')
