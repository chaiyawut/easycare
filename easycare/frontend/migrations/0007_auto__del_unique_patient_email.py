...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Patient', fields ['email']
        db.delete_unique('frontend_patient', ['email'])


    def backwards(self, orm):
        # Adding unique constraint on 'Patient', fields ['email']
        db.create_unique('frontend_patient', ['email'])
    ...
    models = {
        ...
        'frontend.record': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
