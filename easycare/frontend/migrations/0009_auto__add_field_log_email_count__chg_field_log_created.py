...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Log.email_count'
        db.add_column('frontend_log', 'email_count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Log.created'
        db.alter_column('frontend_log', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Log.email_count'
        db.delete_column('frontend_log', 'email_count')


        # Changing field 'Log.created'
        db.alter_column('frontend_log', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'frontend.log': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 0, 0)'}),
            'email_count': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sms_count': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
        'frontend.patient': {
        ...
        'frontend.record': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
