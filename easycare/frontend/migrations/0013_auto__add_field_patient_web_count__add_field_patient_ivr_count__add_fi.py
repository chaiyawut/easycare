...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.web_count'
        db.add_column('frontend_patient', 'web_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Patient.ivr_count'
        db.add_column('frontend_patient', 'ivr_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Patient.sms_count'
        db.add_column('frontend_patient', 'sms_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.web_count'
        db.delete_column('frontend_patient', 'web_count')

        # Deleting field 'Patient.ivr_count'
        db.delete_column('frontend_patient', 'ivr_count')

        # Deleting field 'Patient.sms_count'
        db.delete_column('frontend_patient', 'sms_count')
    ...
    models = {
        ...
        'frontend.patient': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ivr_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'web_count': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'frontend.pressure': {
