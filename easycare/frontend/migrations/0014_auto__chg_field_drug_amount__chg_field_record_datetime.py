...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Drug.amount'
        db.alter_column('frontend_drug', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Drug.amount'
        db.alter_column('frontend_drug', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1))
    ...
    models = {
        ...
        'frontend.drug': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '2', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
